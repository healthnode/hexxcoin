...
const string strMessageMagic = "Hexx Signed Message:\n";
...
{
    int64_t nSubsidy = nCoinAge * ((Params().PoSCoinReward() * CENT)) * 33 / (365 * 33 + 8) + fMasternodePayment * Params().MasternodeFixReward();
