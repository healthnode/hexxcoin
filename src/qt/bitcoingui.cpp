    ...
    nWeight(0)
{
    ...
    setWindowTitle(tr("Hexx") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
    qApp->setWindowIcon(QIcon(":icons/hexx"));
    setWindowIcon(QIcon(":icons/hexx"));
#else
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Hexx address"));
    ...
    aboutAction = new QAction(tr("&About Hexx"), this);
    aboutAction->setToolTip(tr("Show information about Hexx"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Hexx"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/hexx"), tr("&Show / Hide"), this);
...
void BitcoinGUI::setWalletActionsEnabled(bool enabled)
{
    ...
    masternodeManagerAction->setEnabled(enabled);
}
...
#ifndef Q_OS_MAC
            qApp->setWindowIcon(QIcon(":icons/hexx_testnet"));
            setWindowIcon(QIcon(":icons/hexx_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/hexx_testnet"));
#endif
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Hexx client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Hexx client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Hexx network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Hexx address or malformed URI parameters."));
    }
