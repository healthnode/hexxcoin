    ...
    ui(new Ui::EditAddressDialog), mapper(0), mode(mode), model(0)
{
    ...
    ui->addressEdit->setPlaceholderText(tr("Enter a Hexx address (e.g. PKG1Rku9mT5LPUpnpPgDBjNmuWV7XBN1xc)"));
    ...
    if(!saveCurrentRow())
    {
        ...
        case AddressTableModel::INVALID_ADDRESS:
            QMessageBox::warning(this, windowTitle(),
                tr("The entered address \"%1\" is not a valid Hexx address.").arg(ui->addressEdit->text()),
