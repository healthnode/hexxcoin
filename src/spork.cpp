...
bool IsSporkActive(int nSporkID)
{
    ...
    if(mapSporksActive.count(nSporkID)){
        ...
        if(nSporkID == SPORK_8_REPLAY_BLOCKS) r = SPORK_8_REPLAY_BLOCKS_DEFAULT;
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    if(strName == "SPORK_8_REPLAY_BLOCKS") return SPORK_8_REPLAY_BLOCKS;
...
std::string CSporkManager::GetSporkNameByID(int id)
{
    ...
    if(id == SPORK_8_REPLAY_BLOCKS) return "SPORK_8_REPLAY_BLOCKS";
