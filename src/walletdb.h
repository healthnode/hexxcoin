...
public:
    ...
    bool WriteMNodeConfig(std::string sAlias, const CMNodeConfig& nodeConfig);
    bool ReadMNodeConfig(std::string sAlias, CMNodeConfig& nodeConfig);
    bool EraseMNodeConfig(std::string sAlias);
